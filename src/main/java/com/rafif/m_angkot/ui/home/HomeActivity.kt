...
class HomeActivity : AppCompatActivity(), OnMapReadyCallback, HomeContract {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.menu_recommend -> {
                ...
                //Delete data dari shared preferences
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        // Panggil fungsi nyalain permission
        askLocationPermission()
    }
    ...
    private fun fetchGPS() {
        ...
        //Buat tracking kalo lokasi user berubah
        gps.getLocation().observe(this) {
            ...
            //Enable user indicator di map
            map.isMyLocationEnabled = true

            //Cek current state lagi tracking / direction
            if (isTracking) {
    ...
    // Fungsi minta permission location (kalo belum nyala)
    ...
    // Hitung harga (1 km pertama 2000, tiap km selanjutnya nambah 1000)
    ...
    // Untuk parsing data koordinat yg datang dari activity lain
    ...
    // Ngegambar rute dari lokasi user
    ...
    // Pilih lokasi turun untuk search route
    ...
    // Fungsi buat pindah ke activity Rekomendasi Rute
